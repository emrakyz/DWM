...
static const Key keys[] = {
	...
	{ MODKEY,			XK_grave,	spawn,	   {.v = (const char*[]){ "via", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_m,		spawn,	   SHCMD("pactl set-sink-mute 47 toggle") },
	...
	{ MODKEY,			XK_minus,	spawn,	   SHCMD("pactl set-sink-volume 47 -5%") },
	{ MODKEY,			XK_equal,	spawn,	   SHCMD("pactl set-sink-volume 47 +5%") },
